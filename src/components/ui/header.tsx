...
export function Header() {
  const { resetState } = useProjectInit()
  ...
  return (
    <header className="relative border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-50">
